...
// CORREÇÃO AQUI: 'address' em vez de 'adresses'
const passengerAddresses = computed(() => {
  return authStore.state.user?.passenger_data?.address || []
})

const currentAddress = computed(() => {
  return passengerAddresses.value[currentAddressIndex.value] || {}
})

function nextAddress() {
  if (currentAddressIndex.value < passengerAddresses.value.length - 1) {
...
<template>
  <section>
    ...
    <div class="addresses-container">
      <div v-if="passengerAddresses.length === 0" class="no-addresses-container">
        ...
        <v-card class="address-card" elevation="2">
          ...
          <v-card-actions class="card-actions">
            ...
            <v-btn 
              ...
              variant="outlined" 
              color="primary" 
              :disabled="currentAddressIndex === passengerAddresses.length - 1"

...
<template>
    <div class="map-container">
        <GMapMap :center="routePath[0]" :zoom="13" map-type-id="roadmap" style="width: 100%; height: 600px">
            <GMapPolyline :path="routePath" :options="{
                strokeColor: '#db5507',
                strokeOpacity: 0.8,
                strokeWeight: 4
            }" />

            <GMapMarker v-for="(pos, index) in markerPositions" :key="index" :position="pos" />
        </GMapMap>
    </div>
</template>

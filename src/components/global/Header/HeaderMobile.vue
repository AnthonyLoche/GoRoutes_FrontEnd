...
const menuItems = [
    ...
    { name: 'Produtos', icon: 'mdi-package-variant', color: '#2196F3' },
    { name: 'Serviços', icon: 'mdi-tools', color: '#FF9800' },
    { name: 'Sobre', icon: 'mdi-information', color: '#9C27B0' },
    { name: 'Contato', icon: 'mdi-phone', color: '#F44336' },
